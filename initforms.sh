...
INSERT INTO forms ( mytable,group_id,order_id,param,desc,def,cur,new,mandatory,attr,type,link,groupname ) VALUES ( 'forms', 1,4,'maxmemory','MaxMemory: Do not use more memory than the specified amount of byte','1g','','',1, 'maxlen=128', 'inputbox', '', '' );
